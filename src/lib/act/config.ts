// Auto-generated shim — re-exports from @/lib/capm/config
// This lets shared ecosystem components import from "@/lib/act/config"
import type { ExamConfig as _capm_Config } from "@/lib/capm/config";
import { EXAM_CONFIG as _raw } from "@/lib/capm/config";
