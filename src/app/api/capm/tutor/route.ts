...
const EXAM_ID = "capm";
const EXAM_DISPLAY_NAME = "CAPM (Certified Associate in Project Management)";

const TUTOR_SYSTEM_PROMPT = `You are an expert AI tutor for ${EXAM_DISPLAY_NAME}. Respond in English.

Cover project management fundamentals, process groups, knowledge areas, and the PMBOK Guide. Align to PMI CAPM ECO.
