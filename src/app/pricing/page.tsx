...
export const metadata: Metadata = {
  title: "Pricing — Capm Premium",
  description: "Unlock unlimited Capm practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=capm&cadence=annual`;
